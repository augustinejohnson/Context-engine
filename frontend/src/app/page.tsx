            ...
            if (data.type === 'scripture' && data.scriptureReference) {
              ...
              if (verseId) {
                ...
                fetch(mainUrl + tokenQuery, {
                  ...
                  }).catch(err => console.error(`[Bridge] Fallback CreateText also failed (${targetIp}):`, err.message));
                });
              } else {
                ...
                fetch(fallbackUrl + tokenQuery, {
                  ...
                  headers: { 'Content-Type': 'application/json' },
                  body: JSON.stringify({ text: data.content, show: true, display_ahead: true })
                }).catch(err => console.error(`[Bridge] Fallback CreateText failed (${targetIp}):`, err.message));
              }
            } else {
